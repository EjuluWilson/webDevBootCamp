...
app.post("/recipe", (req, res) => {
  ...
  console.log(`The recipe is: ${choiceResponse.recipename}`);
  console.log(`The proteinName is: ${choiceResponse.proteinName}`);
  console.log(`The salsaName is: ${choiceResponse.salsaName}`);
